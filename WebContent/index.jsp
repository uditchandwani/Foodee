...
<script src="foodorder.js" async></script>
...
%>
	...
	<div class="container">
		...
		<div class="log-in-link"><a href="login.jsp" >Log in / Sign up</a></div>
	</div>
	</div>
	...
	<div class="cart-start">
        ...
        <button class="btn-purchase" type="button">CHECK OUT</button>
	</div>
	...
	<footer class="footer-distributed">
			...
			<div class="footer-left">
				<h3 style="font-size: 60px;font-family: 'Jost', sans-serif;">Foodee</h3>
  			</div>
